...
package com.tsj.expertsystems.examples.content;

import com.tsj.expertsystems.examples.content.eco.elements.*;
import com.tsj.expertsystems.examples.content.mso.elements.CD;
import com.tsj.expertsystems.examples.content.mso.elements.Track;
import com.tsj.expertsystems.examples.content.musicShopOntology.MusicShopOntology;
...
public class CDTrader extends Agent {
    ...
    private final Ontology ontology = MusicShopOntology.getInstance();
    ...
    class QueryPriceBehaviour extends OneShotBehaviour {
        ...
        public void action() {
            try {
                ...
                costs.set(MusicShopOntology.COSTS_ITEM, onto.fromObject(it));
            ...
            if (msg != null) {
                try {
                    ...
                    if (ire.getTypeName().equals(SLVocabulary.IOTA)) {
                        AbsPredicate p = ire.getProposition();
    ...
    class InformCostsBehaviour extends OneShotBehaviour {
        ...
        public void action() {
            try {
                ...
                AbsPredicate costs = new AbsPredicate(MusicShopOntology.COSTS);
                costs.set(MusicShopOntology.COSTS_ITEM, ontology.fromObject(it));
                costs.set(MusicShopOntology.COSTS_PRICE, x);
