...
package com.tsj.expertsystems.examples.ontology;

import com.tsj.expertsystems.examples.ontology.employment.*;
...
public class EngagerAgent extends Agent {
    ...
    private final Company representedCompany; // The company on behalf of which this agent is able to engage people
    private final List employees;    // The people currently working for the company
    ...
    class HandleEnganementQueriesBehaviour extends SimpleAchieveREResponder {
        ...
        public ACLMessage prepareResponse(ACLMessage msg) {
            ...
            try {
                ...
                if (!(pred instanceof WorksFor wf)) {
