...
package com.tsj.expertsystems.examples.ontology.employment;
...
public class EmploymentOntology extends Ontology {
    ...
    private static final Ontology theInstance = new EmploymentOntology();
    ...
    private EmploymentOntology() {
        ...
        try {
            ...
            ps.add(WORKS_FOR_PERSON, getSchema(PERSON));
            ps.add(WORKS_FOR_COMPANY, getSchema(COMPANY));
