...
(defrule my-rule12
    (customer (name ?name) (address ?address) (customer-id 101))
   =>
...
(defrule my-rule14
   (not (product (category smartphone) (price ?price&:(> ?price  50)) (name ?n)))
   =>
...
(defrule my-rule15
   (product (category smartphone) (price ?price&:(> ?price  50)) (name ?n))
   =>
